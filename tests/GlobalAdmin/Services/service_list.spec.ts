...
test('Global Admin - Services - Service List', { tag: ["@global_admin", "@services", "@service_list"] }, async ({ page }) => {
...
await allure.step("Verify Partner Name column is visible : ", async() =>{ await expect(page.locator('//tr[@data-testid="item-list"]/th//div[text()="Partner Name"]')).toBeVisible();});

await allure.step("Verify Customer Name column is visible : ", async() =>{ await expect(page.locator('//tr[@data-testid="item-list"]/th//div[text()="Customer Name"]')).toBeVisible();});

await allure.step("Verify Customer Account Number column is visible : ", async() =>{ await expect(page.locator('//tr[@data-testid="item-list"]/th//div[text()="Customer Account Number"]')).toBeVisible();});
...
await allure.step("Verify Services data are visible : ", async() =>{ await expect(page.locator('//table/tbody')).toBeVisible();});

...
test('Global Admin - Analytics - Partner Details', { tag: ["@global_admin", "@analytics", "@partner_details"] }, async ({ page }) => {
...
await allure.step("Verify correct partner summary : 5", async() =>{ await expect(page.locator('//div[text()="Number of Partners"]/following-sibling::div')).toHaveText('5');});

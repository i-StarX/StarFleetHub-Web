...
test('Global Admin - Analytics - Kit Summary', { tag: ["@global_admin", "@analytics", "@kit_summary"] }, async ({ page }) => {
...
await allure.step("Verify correct count of kit : 4", async() =>{ await expect(page.locator('//h3[text()="Device Summary"]/following-sibling::table//tr[1]/td[2]')).toHaveText('4');});
...
await allure.step("Verify correct count of kit : 209", async() =>{ await expect(page.locator('//h3[text()="Device Summary"]/following-sibling::table//tr[2]/td[2]')).toHaveText('209');});
...
await allure.step("Verify correct count of kit : 1140", async() =>{ await expect(page.locator('//h3[text()="Device Summary"]/following-sibling::table//tr[3]/td[2]')).toHaveText('1140');});
...
await allure.step("Verify correct count of kit : 1353", async() =>{ await expect(page.locator('//h3[text()="Device Summary"]/following-sibling::table//tr[4]/td[2]')).toHaveText('1353');});
...
await allure.step("Verify correct count of kit : 325", async() =>{ await expect(page.locator('//h3[text()="Device Summary"]/following-sibling::table//tr[5]/td[2]')).toHaveText('325');});
...
await allure.step("Verify correct count of kit : 9", async() =>{ await expect(page.locator('//h3[text()="Device Summary"]/following-sibling::table//tr[6]/td[2]')).toHaveText('9');});
...
await allure.step("Verify correct count of kit : 1687", async() =>{ await expect(page.locator('//h3[text()="Device Summary"]/following-sibling::table//tr[7]/td[2]')).toHaveText('1687');});

...
test('Global Admin - Login - Admin Login', { tag: ["@global_admin", "@login", "@admin_login"] }, async ({ page }) => {
...
await allure.step("Verify Partners menu is visible : ", async() =>{ await expect(page.locator('//a[@href="#/partners"]')).toBeVisible();});

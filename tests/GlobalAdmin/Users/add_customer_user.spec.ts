...
test('Global Admin - Users - Add Customer User', { tag: ["@global_admin", "@users", "@add_customer_user"] }, async ({ page }) => {
...
await allure.step("Enter email address : rallen.estrella+tc02@istar-x.com", async() =>{ await page.locator('#email').fill('rallen.estrella+tc02@istar-x.com');});

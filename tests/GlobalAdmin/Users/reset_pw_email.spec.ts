...
test('Global Admin - Users - Reset Password email', { tag: ["@global_admin", "@users", "@reset_pw_email"] }, async ({ page }) => {
...
await allure.step("Enter email address : rallen.estrella+resetpw@istar-x.com", async() =>{ await page.locator('[placeholder="Search Users"]').fill('rallen.estrella+resetpw@istar-x.com');});

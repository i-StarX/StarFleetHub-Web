...
test('Partner Read Only - Service Details - Telemetry Details', { tag: ["@partner_reader", "@service_details", "@pr_telemetry_details"] }, async ({ page }) => {
...
await allure.step("Search Kit Number : KITP00264916", async() =>{ await page.locator('[placeholder="Search Services"]').fill('KITP00264916');});
